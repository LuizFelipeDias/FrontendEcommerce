...
import { useCart } from "../Components/CartTest/CartContext"; // Importe o contexto do carrinho
...
const Product = () => {
  ...
  useEffect(() => {
    fetch("https://backend-production-6806.up.railway.app/backend/consultas/categories/all.php")
